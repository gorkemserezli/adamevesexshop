...
export function productCardSkeletonHTML(): string {
  return `<li class="ae-product-card ae-card-skeleton" aria-hidden="true"><div class="block"><div class="aspect-square bg-sunken overflow-hidden rounded-md ae-skeleton-shimmer"></div><p class="ae-skeleton-line font-serif text-[18px] mt-ae-2 leading-tight ae-skeleton-shimmer">&nbsp;</p><p class="ae-skeleton-line ae-skeleton-line-short text-body-sm mt-1 ae-skeleton-shimmer">&nbsp;</p></div></li>`;
}
